...
class TimeSeriesDataFrame(pd.DataFrame):
    ...
    data : pd.DataFrame, str, pathlib.Path or Iterable
        ...
        You can also use :meth:`~TimeSeriesDataFrame.from_iterable_dataset` for loading data in such format.
    ...
    def freq(self):
        ...
        values. For reliable results, use :meth:`~TimeSeriesDataFrame.infer_frequency`.
        """
    ...
    if TYPE_CHECKING:
        ...
        def query(self, expr: str, *, inplace: bool = False, **kwargs) -> Self: ...  # type: ignore
