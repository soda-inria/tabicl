...
def build_predictor(args: dict[str, Any], worker_id: int, gpu_id: int) -> TabPFNVersionPredictor:
    ...
    return TabPFNVersionPredictor(args, "v2")


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run TabPFN v2 classification benchmark inference.")
    shared.add_common_args(parser, default_out_dir="pipeline_compare_result/tabpfn_v2")
